            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg ">
                ...
                <form method="post" action="{{ route('login_post')}}">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="http://sparepartapp.test/lupa_sandi">Lupa Kata Sandi?</a>
                    </div>
                    <div class="flex items-center justify-end mt-4">
                        <a class="class=mb-0 text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500  text-sm">
                            <b>Belum Punya Akun?</b><a href="http://sparepartapp.test/register" class="underline text-sm text-gray-600">Daftar Akun</a>
                        </a>
                    </div>
                </form>
            </div>
